...
const TteokmillSparrowsWhitelistContract_1 = __importDefault(require("../contracts/TteokmillSparrowsWhitelistContract"));
const Wallet_1 = __importDefault(require("../klaytn/Wallet"));
const ViewUtil_1 = __importDefault(require("./ViewUtil"));
class Home {
    constructor() {
        this.container = (0, skynode_1.el)(".home-view", (0, skynode_1.el)("h1", "떡방앗간 참새 NFT 화이트리스팅"), (0, skynode_1.el)("h2", "2021년 12월 28일"), (0, skynode_1.el)("h2", "☆개☆봉☆박☆두☆"), (0, skynode_1.el)("a", { href: "https://www.youtube.com/watch?v=bDFKiwtdBYs", target: "_blank" }, (0, skynode_1.el)("img", { src: "/images/comming-soon.svg", height: "256px" })), (0, skynode_1.el)(".overview", `참새들이 기다리고 기다리던 떡방앗간 참새 NFT...\n가슴이 웅장해지는 그 NFT드디어 나온다.\n개 당 1,000 절미~!`), (0, skynode_1.el)(".input-container", (0, skynode_1.el)(".label", "🚨 카톡 클립은 본인 인증용으로 클립지갑으로 인절미를 절.대. 보내지 말 것 🚨"), (0, skynode_1.el)(".label", "🚨 클립주소 입력하면 화이트리스트 못 받음 그러니깐 카.이.카.스. 주소 입력 할 것🚨"), this.addrInput = (0, skynode_1.el)("input", { placeholder: "카이카스 주소 입력하면 됨" })), (0, skynode_1.el)("button", "화이트 리스트 신청 허기", {
            click: async () => {
                ...
                if (addr !== undefined) {
                    if (await TteokmillSparrowsWhitelistContract_1.default.added(addr) === true) {
                        alert("이미 신청함");
                    }
                    else {
                        if (confirm(`${this.addrInput.domElement.value} 이거 맞지? 틀리면 못사`)) {
                            await TteokmillSparrowsWhitelistContract_1.default.add(this.addrInput.domElement.value);
                            alert("완료");
                        }
                    }
                }
            },
        }), (0, skynode_1.el)("button", "떡방앗간 V2 로오오드맵", {
            click: () => {
