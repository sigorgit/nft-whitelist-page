...
export default class Explanation implements View {
    ...
    constructor() {
        this.container = el(".explanation-view", el("h1", "떡방앗간.느프트"),
            ...
            el(".body", "(정확한 시간은 공지 예정)"),
            el("h2", "2차 거래소"),
            el("a", "클럽스 a.k.a klu.bs", { href: "https://klu.bs", target: "_blank" }),
            ...
            el("a", { href: "https://www.youtube.com/watch?v=UVK9jVAw5SY", target: "_blank" }, el("img", { src: "/images/comming-soon.svg", height: "256px" })),
            el(".footer", el(".sns",
